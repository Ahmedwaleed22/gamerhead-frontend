    ...
    roles: [
      {
        ...
        perks: ['Monthly platform credits', 'Staff badge + verified role', 'Direct line to leadership', 'Early access to platform features'],
        openings: 1,
      },
      {
        id: 'cs-discord',
        ...
        perks: ['Monthly platform credits', 'Staff badge + Discord role', 'Staff channel access'],
        openings: 3,
      },
      {
        id: 'cs-forum',
        ...
        perks: ['Monthly platform credits', 'Staff badge', 'Forum moderator tools access'],
        openings: 2,
      },
    ],
  },
    ...
    roles: [
      {
        ...
        perks: ['Monthly credits + bonus eligibility', 'Staff badge', 'Supervisor tools access', 'Direct leadership contact'],
        openings: 1,
      },
      {
        id: 'ls-match',
        ...
        perks: ['Monthly platform credits', 'Staff badge', 'Priority queue tools access'],
        openings: 4,
      },
      {
        id: 'ls-chat',
        ...
        perks: ['Monthly platform credits', 'Staff badge', 'Internal tools access'],
        openings: 3,
      },
    ],
  },
    ...
    roles: [
      {
        ...
        perks: ['Monthly credits + bonus eligibility', 'Staff badge', 'Case management access', 'Direct leadership line'],
        openings: 1,
      },
      {
        id: 'ts-match',
        ...
        perks: ['Monthly platform credits', 'Staff badge', 'Ticket system access'],
        openings: 3,
      },
      {
        id: 'ts-general',
        ...
        perks: ['Monthly platform credits', 'Staff badge', 'Admin tools access'],
        openings: 2,
      },
    ],
  },
